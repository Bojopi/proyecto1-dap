  ...
  return (
    <main className="min-h-screen w-full flex items-center justify-center bg-[#F3F1E8] p-6">
      ...
      <div className="w-full max-w-[750px] h-[500px] flex rounded-2xl overflow-hidden shadow-lg border border-[#6D756D]">
        ...
        {/* LADO DERECHO - COLOR CELESTE */}
        <div className="w-1/2 bg-[#B8D4D8] flex items-center justify-center">
          ...
          <div className="text-center px-8">
            ...
            <h2 className="text-3xl font-serif text-[#26382C]">
              NUEVA VIDA
            </h2>

            <p className="mt-3 text-lg font-serif text-[#40534A]">
              Recicla hoy,
              <br />
              transforma mañana.
            </p>
