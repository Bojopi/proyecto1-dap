	...
	return (
		<div className="min-h-screen bg-[#e8e4d8] text-[#20251f]">
			...
			<main className="mx-auto max-w-7xl px-5 pb-12 pt-10 sm:px-8">
				...
				<h1 className="mt-2 text-4xl font-black uppercase">Proyectos de escuadrón</h1>
				<p className="mt-3 text-[#68705f]">Organiza tus próximas operaciones y configuraciones de vehículos.</p>
			</main>
		</div>
	);
}
